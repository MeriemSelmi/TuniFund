...
public class AuthentificationActivity extends Activity implements View.OnClickListener{
    EditText cin,pass;
	...
	public void onClick(View v) {
		...
		//récupérer l'utilisateur s'il existe avec le login et le mot de passe entrés 
    	User user=userBdd.login(cin.getText().toString(),pass.getText().toString());
         if(user==null)
         {
    		Toast.makeText(AuthentificationActivity.this,"Authentification non valide!",Toast.LENGTH_LONG).show();
         }
         else
         {
			...
			Intent intent=new Intent(AuthentificationActivity.this,ActivitySuiv.class);
